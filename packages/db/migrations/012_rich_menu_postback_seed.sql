-- Migration 012: DENBAラウンジ リッチメニュー postback シナリオ 11本シード
-- 画像URLプレースホルダは実画像アップロード後に UPDATE で差し替え可能
-- KEIDO_IMAGE_URL / URAWA_IMAGE_URL / DENBA_INTRO_IMAGE_URL → placehold.co 仮URL使用中
